Aplikacja Spring Boot z Thymeleaf Opis działania Aplikacja wykorzystuje Spring Boot do obsługi żądań HTTP oraz Thymeleaf jako silnika szablonów HTML. Główne funkcjonalności aplikacji obejmują:
